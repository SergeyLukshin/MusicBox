...
public class FolderItemAdapter extends BaseAdapter implements View.OnClickListener/*, Filterable*/ {
    Context ctx;
    LayoutInflater lInflater;
    public ArrayList<FolderItem> objects = null;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        FolderItem p = getRadioItem(position);
    ...
    // товар по позиции
    FolderItem getRadioItem(int position) {
        return ((FolderItem) getItem(position));
    }
}
