...
public class Widget extends AppWidgetProvider {
    ...
    //static HashMap<Integer, Boolean> m_setNoHideConfig = new HashMap<Integer, Boolean>();
    ...
    public void onAppWidgetOptionsChanged(Context context,
                                          ...
                                          Bundle newOptions) {
        //int appWidgetMinWidth = (Integer) newOptions.get("appWidgetMaxWidth");
        /*int appWidgetMinHeight = (Integer)  newOptions.get("appWidgetMinHeight");
        if (appWidgetMinHeight > 48)
            m_setNoHideConfig.put(Integer.valueOf(appWidgetId), Boolean.valueOf(true));
        else
            m_setNoHideConfig.put(Integer.valueOf(appWidgetId), Boolean.valueOf(false));*/
    ...
    void updateWidget(Context context, AppWidgetManager appWidgetManager) {
        ...
        for (int widgetID : arr_widgets) {
            ...
            int appWidgetMinHeight = providerInfo.minHeight;
            boolean bNoHideConfig = false;

            if (mAppWidgetOptions != null && mAppWidgetOptions.getInt(AppWidgetManager.OPTION_APPWIDGET_MIN_HEIGHT) > 0) {

                appWidgetMinHeight = mAppWidgetOptions.getInt(AppWidgetManager.OPTION_APPWIDGET_MIN_HEIGHT);

            }

            if (appWidgetMinHeight > 50)
                bNoHideConfig = true;
            else
                bNoHideConfig = false;
            ...
            int valType = 0;//sp.getInt(ConfigActivity.WIDGET_TYPE + widgetID, 0);
            ...
            if (valTheme == 0) // black
            {
                ...
                remoteViews.setTextColor(R.id.tvTitle, context.getResources().getColor(R.color.colorWhite));
                remoteViews.setTextColor(R.id.tvMainName, context.getResources().getColor(R.color.colorWhite));
                remoteViews.setTextColor(R.id.tvTitleSmall, context.getResources().getColor(R.color.colorWhite));
                ...
                remoteViews.setTextColor(R.id.tvTitle, context.getResources().getColor(R.color.colorBlack));
                remoteViews.setTextColor(R.id.tvMainName, context.getResources().getColor(R.color.colorBlack));
                remoteViews.setTextColor(R.id.tvTitleSmall, context.getResources().getColor(R.color.colorBlack));
                    ...
                    case Const.STATE_STOP:
                        ...
                        if (valShowIcon == 1) {
                            if (p.type == Const.TYPE_RADIO && p.radioid > 0) {
                                ...
                                if (icon_btm != null)
                                    remoteViews.setImageViewBitmap((int) idIV.get(index), icon_btm);
                                else
                                    remoteViews.setImageViewResource((int) idIV.get(index), R.drawable.radio_);
                            }
                            ...
                            if (p.type == Const.TYPE_FOLDER) {
                                remoteViews.setImageViewResource((int) idIV.get(index), R.drawable.folder_);
                            }

                            if (p.type == Const.TYPE_PLAYLIST) {
                                remoteViews.setImageViewResource((int) idIV.get(index), R.drawable.playlist_);
                            }
                        }
                        else
                        ...
                        if (valShowFileName == 1) {
                            ...
                            //if (!p.name.equalsIgnoreCase(p.GetTitle())) {
                                ...
                                if (btm != null) {
                                    ...
                                    remoteViews.setImageViewResource(R.id.ivImage, R.drawable.ic_main_large);
                            //}
                        }
                        else {
